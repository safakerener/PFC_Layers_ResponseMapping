...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "IntroBaby" ---
    key_resp_14 = keyboard.Keyboard()
    text_17 = visual.TextStim(win=win, name='text_17',
        text="Now, it's time for some practice. \nThe correct responses will be highlighted in green and incorrect responses will be red. You can take all the time you need to decide. \n\n\n\n\n\npress space to begin the practice",
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    cue = visual.ImageStim(
        ...
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    fixCrossR_6 = visual.ShapeStim(
        win=win, name='fixCrossR_6', vertices='cross',
        size=(0.02, 0.02),
    ...
    # --- Initialize components for Routine "bResponse" ---
    fixCross_2 = visual.ShapeStim(
        win=win, name='fixCross_2', vertices='cross',
        size=(0.02, 0.02),
        ori=0.0, pos=(0, 0), anchor='center',
    ...
    text1_2 = visual.TextStim(win=win, name='text1_2',
        text='',
        font='Open Sans',
        units='norm', pos=(-.225, .08), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-1.0);
    text2_2 = visual.TextStim(win=win, name='text2_2',
        text='',
        font='Open Sans',
        units='norm', pos=(-.075, .08), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
    ...
    text8_2 = visual.TextStim(win=win, name='text8_2',
        ...
        languageStyle='LTR',
        depth=-8.0);
    kb_2 = keyboard.Keyboard()
    num1_2 = visual.TextStim(win=win, name='num1_2',
        text='',
        font='Open Sans',
        units='norm', pos=(-.225, .24), height=0.1, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-10.0);
    num2_2 = visual.TextStim(win=win, name='num2_2',
        text='',
        font='Open Sans',
        units='norm', pos=(-.075, .24), height=0.1, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-11.0);
    num3_2 = visual.TextStim(win=win, name='num3_2',
        text='',
        font='Open Sans',
        units='norm', pos=(.075, .24), height=0.1, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-12.0);
    num4_2 = visual.TextStim(win=win, name='num4_2',
        text='',
        font='Open Sans',
        units='norm', pos=(.225, .24), height=0.1, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-13.0);
    # Run 'Begin Experiment' code from changecolour_2
    
    response_map_2 = {
        '1': [text1_2, text5_2, num1_2],
        '2': [text2_2, text6_2, num2_2],
        '3': [text3_2, text7_2, num3_2],
        '4': [text4_2, text8_2, num4_2]}
    key_resp_2 = keyboard.Keyboard()
    
    # --- Initialize components for Routine "trainingIntro" ---
    text_20 = visual.TextStim(win=win, name='text_20',
        text='Great!\n\nYou will not receive any more feedback on your answers throughout the experiment, and your response window is now limited to 3 seconds. So, before we start the actual experiment, we will now run a realistic training scenario. \n\nIn order to finish this training, you must perform with high accuracy.\n\n\n\n\nTraining will begin shortly.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    trialsFilepath = f'participantData/s{numParticipant}/block_{numSession}/trialMatrix_s{numParticipant}_{numSession}.xlsx'
    babyStepsFilepath= f'participantData/s{numParticipant}/block_0/babySteps_s{numParticipant}.xlsx'
    ...
    # set up handler to look after randomisation of conditions etc
    babyEnter = data.TrialHandler(nReps=trainingEnter, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='babyEnter')
    thisExp.addLoop(babyEnter)  # add the loop to the experiment
    thisBabyEnter = babyEnter.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisBabyEnter.rgb)
    if thisBabyEnter != None:
        for paramName in thisBabyEnter:
            globals()[paramName] = thisBabyEnter[paramName]
    
    for thisBabyEnter in babyEnter:
        currentLoop = babyEnter
        thisExp.timestampOnFlip(win, 'thisRow.t')
        # pause experiment here if requested
        if thisExp.status == PAUSED:
            pauseExperiment(
        ...
        # --- Prepare to start Routine "IntroBaby" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('IntroBaby.started', globalClock.getTime())
        key_resp_14.keys = []
        key_resp_14.rt = []
        _key_resp_14_allKeys = []
        # keep track of which components have finished
        IntroBabyComponents = [key_resp_14, text_17]
        for thisComponent in IntroBabyComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            if key_resp_14.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_14_allKeys):
                    ...
                    key_resp_14.duration = [key.duration for key in _key_resp_14_allKeys]
        ...
        # --- Ending Routine "IntroBaby" ---
        for thisComponent in IntroBabyComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('IntroBaby.stopped', globalClock.getTime())
        ...
        babyEnter.addData('key_resp_14.keys',key_resp_14.keys)
        if key_resp_14.keys != None:  # we had a response
            babyEnter.addData('key_resp_14.rt', key_resp_14.rt)
            babyEnter.addData('key_resp_14.duration', key_resp_14.duration)
        # the Routine "IntroBaby" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed trainingEnter repeats of 'babyEnter'
    
    # get names of stimulus parameters
    if babyEnter.trialList in ([], [None], None):
        params = []
    else:
        params = babyEnter.trialList[0].keys()
    # save data for this loop
    babyEnter.saveAsExcel(filename + '.xlsx', sheetName='babyEnter',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    
    # set up handler to look after randomisation of conditions etc
    babySteps = data.TrialHandler(nReps=trainingEnter, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions(babyStepsFilepath),
        seed=None, name='babySteps')
    thisExp.addLoop(babySteps)  # add the loop to the experiment
    thisBabyStep = babySteps.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisBabyStep.rgb)
    if thisBabyStep != None:
        for paramName in thisBabyStep:
            globals()[paramName] = thisBabyStep[paramName]
    
    for thisBabyStep in babySteps:
        currentLoop = babySteps
        thisExp.timestampOnFlip(win, 'thisRow.t')
        # pause experiment here if requested
        if thisExp.status == PAUSED:
            pauseExperiment(
        ...
        # keep track of which components have finished
        taskcueComponents = [cue, fixCrossR_6]
        ...
        while continueRoutine:
            ...
            # if fixCrossR_6 is starting this frame...
            if fixCrossR_6.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                fixCrossR_6.frameNStart = frameN  # exact frame index
                fixCrossR_6.tStart = t  # local t and not account for scr refresh
                fixCrossR_6.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(fixCrossR_6, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'fixCrossR_6.started')
                # update status
                fixCrossR_6.status = STARTED
                fixCrossR_6.setAutoDraw(True)
            
            # if fixCrossR_6 is active this frame...
            if fixCrossR_6.status == STARTED:
                # update params
                pass
            
            # if fixCrossR_6 is stopping this frame...
            if fixCrossR_6.status == STARTED:
                if frameN >= 60:
                    # keep track of stop time/frame for later
                    fixCrossR_6.tStop = t  # not accounting for scr refresh
                    fixCrossR_6.frameNStop = frameN  # exact frame index
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'fixCrossR_6.stopped')
                    # update status
                    fixCrossR_6.status = FINISHED
                    fixCrossR_6.setAutoDraw(False)
        ...
        # the Routine "taskcue" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        
        # set up handler to look after randomisation of conditions etc
        babyloop = data.TrialHandler(nReps=3.0, method='sequential', 
            extraInfo=expInfo, originPath=-1,
            trialList=[None],
            seed=None, name='babyloop')
        thisExp.addLoop(babyloop)  # add the loop to the experiment
        thisBabyloop = babyloop.trialList[0]  # so we can initialise stimuli with some values
        # abbreviate parameter names if possible (e.g. rgb = thisBabyloop.rgb)
        if thisBabyloop != None:
            for paramName in thisBabyloop:
                globals()[paramName] = thisBabyloop[paramName]
        
        for thisBabyloop in babyloop:
            currentLoop = babyloop
            thisExp.timestampOnFlip(win, 'thisRow.t')
            # pause experiment here if requested
            if thisExp.status == PAUSED:
                pauseExperiment(
            ...
            if thisSession is not None:
                # if running in a Session with a Liaison client, send data up to now
                thisSession.sendExperimentData()
        # completed 3.0 repeats of 'babyloop'
        
        # get names of stimulus parameters
        if babyloop.trialList in ([], [None], None):
            params = []
        else:
            params = babyloop.trialList[0].keys()
        # save data for this loop
        babyloop.saveAsExcel(filename + '.xlsx', sheetName='babyloop',
            stimOut=params,
            dataOut=['n','all_mean','all_std', 'all_raw'])
        
        # --- Prepare to start Routine "bResponse" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('bResponse.started', globalClock.getTime())
        fixCross_2.setFillColor('black')
        fixCross_2.setLineColor('black')
        text1_2.setColor('white', colorSpace='rgb')
        text1_2.setText(resp1)
        text2_2.setColor('white', colorSpace='rgb')
        text2_2.setText(resp2
        )
        text3_2.setColor('white', colorSpace='rgb')
        text3_2.setText(resp3)
        text4_2.setColor('white', colorSpace='rgb')
        text4_2.setText(resp4
        )
        text5_2.setColor('white', colorSpace='rgb')
        text5_2.setText(resp5)
        text6_2.setColor('white', colorSpace='rgb')
        text6_2.setText(resp6)
        text7_2.setColor('white', colorSpace='rgb')
        text7_2.setText(resp7)
        text8_2.setColor('white', colorSpace='rgb')
        text8_2.setText(resp8)
        kb_2.keys = []
        kb_2.rt = []
        _kb_2_allKeys = []
        num1_2.setColor('white', colorSpace='rgb')
        num1_2.setText('1')
        num2_2.setColor('white', colorSpace='rgb')
        num2_2.setText('2')
        num3_2.setColor('white', colorSpace='rgb')
        num3_2.setText('3')
        num4_2.setColor('white', colorSpace='rgb')
        num4_2.setText('4')
        # Run 'Begin Routine' code from changecolour_2
        ...
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        bResponseComponents = [fixCross_2, text1_2, text2_2, text3_2, text4_2, text5_2, text6_2, text7_2, text8_2, kb_2, num1_2, num2_2, num3_2, num4_2, key_resp_2]
        for thisComponent in bResponseComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            # if fixCross_2 is starting this frame...
            if fixCross_2.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
            ...
            # if text1_2 is starting this frame...
            if text1_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text1_2.started')
                # update status
                text1_2.status = STARTED
                text1_2.setAutoDraw(True)
            
            # if text1_2 is active this frame...
            ...
            # if text3_2 is starting this frame...
            if text3_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text3_2.started')
                # update status
                text3_2.status = STARTED
                text3_2.setAutoDraw(True)
            
            # if text3_2 is active this frame...
            if text3_2.status == STARTED:
                # update params
                pass
            
            # *text4_2* updates
            
            # if text4_2 is starting this frame...
            if text4_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text4_2.started')
                # update status
                text4_2.status = STARTED
                text4_2.setAutoDraw(True)
            
            # if text4_2 is active this frame...
            if text4_2.status == STARTED:
                # update params
                pass
            
            # *text5_2* updates
            
            # if text5_2 is starting this frame...
            if text5_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text5_2.started')
                # update status
                text5_2.status = STARTED
                text5_2.setAutoDraw(True)
            
            # if text5_2 is active this frame...
            if text5_2.status == STARTED:
                # update params
                pass
            ...
            if text6_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text6_2.started')
                # update status
            ...
            # if text7_2 is starting this frame...
            if text7_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text7_2.started')
                # update status
                text7_2.status = STARTED
                text7_2.setAutoDraw(True)
            
            # if text7_2 is active this frame...
            if text7_2.status == STARTED:
                # update params
                pass
            
            # *text8_2* updates
            
            # if text8_2 is starting this frame...
            if text8_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                ...
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'text8_2.started')
                # update status
                text8_2.status = STARTED
                text8_2.setAutoDraw(True)
            
            # if text8_2 is active this frame...
            if text8_2.status == STARTED:
                # update params
                pass
            ...
            # if kb_2 is starting this frame...
            if kb_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                kb_2.frameNStart = frameN  # exact frame index
                kb_2.tStart = t  # local t and not account for scr refresh
                kb_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(kb_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'kb_2.started')
                # update status
                kb_2.status = STARTED
                # keyboard checking is just starting
                waitOnFlip = True
                win.callOnFlip(kb_2.clock.reset)  # t=0 on next screen flip
                win.callOnFlip(kb_2.clearEvents, eventType='keyboard')  # clear events on next screen flip
            if kb_2.status == STARTED and not waitOnFlip:
                theseKeys = kb_2.getKeys(keyList=['1','2','3','4'], ignoreKeys=["escape"], waitRelease=False)
                _kb_2_allKeys.extend(theseKeys)
                if len(_kb_2_allKeys):
                    kb_2.keys = _kb_2_allKeys[0].name  # just the first key pressed
                    kb_2.rt = _kb_2_allKeys[0].rt
                    kb_2.duration = _kb_2_allKeys[0].duration
            
            # *num1_2* updates
            
            # if num1_2 is starting this frame...
            if num1_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                num1_2.frameNStart = frameN  # exact frame index
                num1_2.tStart = t  # local t and not account for scr refresh
                num1_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(num1_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'num1_2.started')
                # update status
                num1_2.status = STARTED
                num1_2.setAutoDraw(True)
            
            # if num1_2 is active this frame...
            if num1_2.status == STARTED:
                # update params
                pass
            
            # *num2_2* updates
            
            # if num2_2 is starting this frame...
            if num2_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                num2_2.frameNStart = frameN  # exact frame index
                num2_2.tStart = t  # local t and not account for scr refresh
                num2_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(num2_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'num2_2.started')
                # update status
                num2_2.status = STARTED
                num2_2.setAutoDraw(True)
            
            # if num2_2 is active this frame...
            if num2_2.status == STARTED:
                # update params
                pass
            
            # *num3_2* updates
            
            # if num3_2 is starting this frame...
            if num3_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                num3_2.frameNStart = frameN  # exact frame index
                num3_2.tStart = t  # local t and not account for scr refresh
                num3_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(num3_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'num3_2.started')
                # update status
                num3_2.status = STARTED
                num3_2.setAutoDraw(True)
            
            # if num3_2 is active this frame...
            if num3_2.status == STARTED:
                # update params
                pass
            
            # *num4_2* updates
            
            # if num4_2 is starting this frame...
            if num4_2.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                num4_2.frameNStart = frameN  # exact frame index
                num4_2.tStart = t  # local t and not account for scr refresh
                num4_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(num4_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'num4_2.started')
                # update status
                num4_2.status = STARTED
                num4_2.setAutoDraw(True)
            
            # if num4_2 is active this frame...
            if num4_2.status == STARTED:
                # update params
                pass
            # Run 'Each Frame' code from changecolour_2
            ...
            if not key_pressed:
                ...
                if keys:
                    key_pressed = True
                    start = t
                    fixCross_2.setColor([1, 0, 1], 'rgb')  # Set the color of the fixCross
                    
                    if kb_2.keys == correctButton:
                        hit = 1
            
                    for key, response_components_2 in response_map_2.items():
                        if key in keys and hit == 1:
                     #       fixCross_2.setColor([0, 1, 0], 'rgb')  # Set the color of the fixCross
                            for component in response_components_2:
                                component.setColor([0, 1, 0], 'rgb')  # Set the color of the fixCross
                        elif key in keys and hit == 0:
                       #     fixCross_2.setColor([1, 0, 0], 'rgb')  # Set the color of the component
                            for component in response_components_2:
                                    component.setColor([1, 0, 0], 'rgb')  # Set the color of the component
                                    
                            rightcomp = response_map_2[str(correctButton)]
                            
                            for ind in rightcomp:
                                ind.setColor([0, 1, 0], 'rgb')
        ...
        # --- Ending Routine "bResponse" ---
        for thisComponent in bResponseComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('bResponse.stopped', globalClock.getTime())
        # check responses
        if kb_2.keys in ['', [], None]:  # No response was made
            kb_2.keys = None
        babySteps.addData('kb_2.keys',kb_2.keys)
        if kb_2.keys != None:  # we had a response
            babySteps.addData('kb_2.rt', kb_2.rt)
            babySteps.addData('kb_2.duration', kb_2.duration)
        # Run 'End Routine' code from changecolour_2
        fixCross.setColor([0, 0, 0], 'rgb')  # Set to black 
        # check responses
        if key_resp_2.keys in ['', [], None]:  # No response was made
            key_resp_2.keys = None
        babySteps.addData('key_resp_2.keys',key_resp_2.keys)
        if key_resp_2.keys != None:  # we had a response
            babySteps.addData('key_resp_2.rt', key_resp_2.rt)
            babySteps.addData('key_resp_2.duration', key_resp_2.duration)
        # the Routine "bResponse" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed trainingEnter repeats of 'babySteps'
    
    # get names of stimulus parameters
    if babySteps.trialList in ([], [None], None):
        params = []
    else:
        params = babySteps.trialList[0].keys()
    # save data for this loop
    babySteps.saveAsExcel(filename + '.xlsx', sheetName='babySteps',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    
    # set up handler to look after randomisation of conditions etc
    trainLoop = data.TrialHandler(nReps=trainingEnter, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
    ...
    for thisTrainLoop in trainLoop:
        ...
        # --- Prepare to start Routine "trainingIntro" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('trainingIntro.started', globalClock.getTime())
        key_resp_15.keys = []
        key_resp_15.rt = []
        _key_resp_15_allKeys = []
        # keep track of which components have finished
        trainingIntroComponents = [text_20, key_resp_15]
        for thisComponent in trainingIntroComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            if text_20.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > text_20.tStartRefresh + 10000-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if key_resp_15.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_15_allKeys):
                    ...
                    key_resp_15.duration = [key.duration for key in _key_resp_15_allKeys]
                    # a response ends the routine
                    continueRoutine = False
        ...
        # --- Ending Routine "trainingIntro" ---
        for thisComponent in trainingIntroComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('trainingIntro.stopped', globalClock.getTime())
        # check responses
        if key_resp_15.keys in ['', [], None]:  # No response was made
            key_resp_15.keys = None
        trainLoop.addData('key_resp_15.keys',key_resp_15.keys)
        if key_resp_15.keys != None:  # we had a response
            trainLoop.addData('key_resp_15.rt', key_resp_15.rt)
            trainLoop.addData('key_resp_15.duration', key_resp_15.duration)
        # the Routine "trainingIntro" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed trainingEnter repeats of 'trainLoop'
    
    # get names of stimulus parameters
    if trainLoop.trialList in ([], [None], None):
        params = []
    else:
        params = trainLoop.trialList[0].keys()
    # save data for this loop
    trainLoop.saveAsExcel(filename + '.xlsx', sheetName='trainLoop',
        stimOut=params,
        dataOut=['n','all_mean','all_std', 'all_raw'])
    ...
    while continueRoutine:
        ...
        # if fixCrossR_5 is starting this frame...
        if fixCrossR_5.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
            # keep track of start time/frame for later
            fixCrossR_5.frameNStart = frameN  # exact frame index
            fixCrossR_5.tStart = t  # local t and not account for scr refresh
            fixCrossR_5.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(fixCrossR_5, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'fixCrossR_5.started')
            # update status
            fixCrossR_5.status = STARTED
            fixCrossR_5.setAutoDraw(True)
        
        # if fixCrossR_5 is active this frame...
        if fixCrossR_5.status == STARTED:
            # update params
            pass
