...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\willi\\Desktop\\PFC_Layers\\PFC_Layers_ResponseMapping\\Pilot\\pilotv1_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    trial = data.TrialHandler(nReps=1.0, method='sequential', 
        ...
        trialList=data.importConditions('trialMatrices/trialMatrix_s61_0.xlsx'),
